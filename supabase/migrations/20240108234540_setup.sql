...
AS $$
DECLARE
  project_url TEXT := 'https://ojbvoeaydjkwqfvshvza.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qYnZvZWF5ZGprd3FmdnNodnphIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjczNjk3OCwiZXhwIjoyMDIyMzEyOTc4fQ.1tqN4R-pXASV4xLA2M_ednEJoFwXjTTP-HodwSDtr7Y'; -- full access needed for http request to storage
